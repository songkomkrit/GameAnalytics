...
def callback_message(topic, msg):
    ...
    if player not in summary:
        ...
        summary.update(OrderedDict({player: {'group': 'null',
                                             'time': 0,
                                             'count': 0,
                                             'attr': [0]*6}}))
